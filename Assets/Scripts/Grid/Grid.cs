...
public class Grid : MonoBehaviour
{
    ...
    public void UpdateObjectInGrid(GridObject gridObject, GridTile currentTile, GridTile newGridTile)
    {
        RemoveGridObjectFromTile(currentTile);
        SetObjectToTile(gridObject, newGridTile);
    }
}